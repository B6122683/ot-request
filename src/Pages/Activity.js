...
const ReactStyle = () => (
  <Container>
    <Row>
      ...
      <Image style={{height: 200, width: '100%', objectFit: 'cover', margin: '5px'}} alt= "" src={images1} />
      <h5>กิจกรรมทำบุญ บริษัท ประจำปี 2565</h5>
      </Col>
      <Col className='colact' sm>
      <Image style={{height: 200, width: '100%', objectFit: 'cover', margin: '5px'}} alt= "" src={images2} />
        <h5>กิจกรรมมอบทุนการศึกษา</h5>
      </Col>
      <Col className='colact' sm>
      <Image style={{height: 200, width: '100%', objectFit: 'cover', margin: '5px'}} alt= "" src={images3} />
